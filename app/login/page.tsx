        ...
        <div className="card p-8">
          ...
          <div className="mt-8 pt-6 border-t border-surface-100">
            ...
            <div className="grid grid-cols-1 gap-3">
              {[
                { role: 'Employee', email: 'employee@company.com', color: 'bg-brand-50 text-brand-600' },
                { role: 'Manager', email: 'manager@company.com', color: 'bg-purple-50 text-purple-600' },
                { role: 'Admin', email: 'admin@company.com', color: 'bg-amber-50 text-amber-600' }
              ].map((d) => (
